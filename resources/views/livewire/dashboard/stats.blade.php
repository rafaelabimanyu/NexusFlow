<div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
    <!-- Total Leads -->
    <x-stat-card label="Total Leads" :value="$totalLeads" icon="default" trend="+12.5%">
    ...
    <!-- Active Mentoring -->
    <x-stat-card label="Active Sessions" :value="$activeSessions" icon="success" trend="+4.2%">
        <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <!-- Pending Tasks -->
    <x-stat-card label="Pending Tasks" :value="$pendingTasks" icon="warning" trend="-1.5%">
        <svg class="size-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
